...
-- Library init
    getgenv().Library = {
        ...
        -- Р вЂќР С‘Р Р…Р В°Р СР С‘РЎвЂЎР ВµРЎРѓР С”Р С‘Р в„– Р Р†Р В°РЎвЂљР ВµРЎР‚Р СР В°РЎР‚Р С”
        WatermarkText = "shariktools.lua"; -- РЎвЂљР ВµР С”РЎРѓРЎвЂљ Р Р†Р В°РЎвЂљР ВµРЎР‚Р СР В°РЎР‚Р С”Р В° (Р СР С•Р В¶Р ВµРЎв‚¬РЎРЉ Р СР ВµР Р…РЎРЏРЎвЂљРЎРЉ)
        WatermarkTemplate = ""; -- РЎв‚¬Р В°Р В±Р В»Р С•Р Р… РЎРѓ Р С—Р В»Р ВµР в„–РЎРѓРЎвЂ¦Р С•Р В»Р Т‘Р ВµРЎР‚Р В°Р СР С‘ {build}, {fps}, {ping}
        WatermarkIsDev = false; -- true = "dev", false = "user"
        WatermarkLastFPS = 0;
        WatermarkLastPing = 0;
        WatermarkUpdating = false; -- РЎвЂћР В»Р В°Р С–, РЎвЂЎРЎвЂљР С•Р В±РЎвЂ№ Р Р…Р Вµ РЎРѓР С•Р В·Р Т‘Р В°Р Р†Р В°РЎвЂљРЎРЉ Р Р…Р ВµРЎРѓР С”Р С•Р В»РЎРЉР С”Р С• RenderStepped Р С—Р С•Р Т‘Р С—Р С‘РЎРѓР С•Р С”
    }
    ...
    -- EXECUTOR COMPATIBILITY SYSTEM
    -- РџСЂРѕРІРµСЂСЏРµС‚ РЅР°Р»РёС‡РёРµ UNC/sUNC С„СѓРЅРєС†РёР№ РїСЂРё СЃС‚Р°СЂС‚Рµ.
    -- РСЃРїРѕР»СЊР·РѕРІР°РЅРёРµ РІ main.lua:
    --   Section:Toggle({
    --       Name = "My Feature",
    --       Requires = {"hookmetamethod", "cloneref"},
    --       Callback = function(v) ... end,
    --   })
    -- в•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђ
    do
        -- РЎРїРёСЃРѕРє С„СѓРЅРєС†РёР№ РґР»СЏ РїСЂРѕРІРµСЂРєРё (РіР»РѕР±Р°Р»СЊРЅС‹Рµ)
        local PLAIN_FUNCS: {string} = {
            -- Environment
            "getgenv", "getrenv", "getsenv",
            -- Memory / GC
            "getgc", "filtergc", "getinstances", "getnilinstances",
            "getupvalues", "getupvalue", "setupvalue",
            -- Hooking
            "hookfunction", "hookmetamethod", "replaceclosure",
            "newcclosure", "clonefunction",
            -- File System
            "makefolder", "isfile", "isfolder", "writefile",
            "readfile", "delfile", "listfiles", "appendfile",
            -- Assets
            "getcustomasset",
            -- UI Protection
            "gethui",
            ...
            "firesignal", "fireproximityprompt",
            -- Metatable
            "getrawmetatable", "setrawmetatable",
            "isreadonly", "setreadonly",
            "gethiddenproperty", "sethiddenproperty",
            -- Thread
            "getthreadidentity", "setthreadidentity", "checkcaller",
            -- Script
            "getscriptclosure", "getscripthash",
            "getscriptfromthread", "getrunningscripts",
            "getloadedmodules", "getscripts",
            -- Closure / Misc
            "isexecutorclosure", "checkclosure", "decompile", "cloneref",
            "identifyexecutor", "getnamecallmethod", "getconnections",
            "getcallingscript", "getfunctionhash",
            "cleardrawcache", "isrenderobj",
            "base64_encode", "base64_decode",
        }

        -- debug.* sub-С„СѓРЅРєС†РёРё
        local DEBUG_FUNCS: {string} = {
            "getinfo", "getupvalue", "setupvalue", "getupvalues",
            "getproto", "getprotos", "getstack", "setstack",
            "getconstant", "setconstant", "getconstants",
        }

        -- cache.* sub-С„СѓРЅРєС†РёРё
        local CACHE_FUNCS: {string} = {
            "iscached", "replace", "invalidate",
        }

        local supported: {[string]: boolean} = {}

        -- РџСЂРѕРІРµСЂСЏРµРј РѕР±С‹С‡РЅС‹Рµ РіР»РѕР±Р°Р»СЊРЅС‹Рµ С„СѓРЅРєС†РёРё
        for _, name in PLAIN_FUNCS do
            local ok, val = pcall(function() return _G[name] end)
            supported[name] = ok and type(val) == "function"
        end

        -- РџСЂРѕРІРµСЂСЏРµРј debug.*
        local debugOk, debugTbl = pcall(function() return debug end)
        if debugOk and type(debugTbl) == "table" then
            for _, fn in DEBUG_FUNCS do
                local key = "debug." .. fn
                supported[key] = type(debugTbl[fn]) == "function"
            end
        else
            for _, fn in DEBUG_FUNCS do
                supported["debug." .. fn] = false
            end
        end

        -- РџСЂРѕРІРµСЂСЏРµРј cache.*
        local cacheOk, cacheTbl = pcall(function() return cache end)
        if cacheOk and type(cacheTbl) == "table" then
            for _, fn in CACHE_FUNCS do
                local key = "cache." .. fn
                supported[key] = type(cacheTbl[fn]) == "function"
            end
        else
            for _, fn in CACHE_FUNCS do
                supported["cache." .. fn] = false
            end
        end

        -- Drawing API (РѕР±СЉРµРєС‚, РЅРµ С„СѓРЅРєС†РёСЏ)
        local drawOk, drawTbl = pcall(function() return Drawing end)
        supported["Drawing"] = drawOk and type(drawTbl) == "table" and type(drawTbl.new) == "function"

        -- РЎРѕС…СЂР°РЅСЏРµРј РІ Library
        Library.Compat = supported

        -- Р’РѕР·РІСЂР°С‰Р°РµС‚ (ok: bool, missing: {string})
        -- ok = true РµСЃР»Рё РІСЃРµ required С„СѓРЅРєС†РёРё РїРѕРґРґРµСЂР¶РёРІР°СЋС‚СЃСЏ
        function Library:CompatCheck(required: {string}): (boolean, {string})
            local missing: {string} = {}
            for _, name in required do
                if not Library.Compat[name] then
        ...
        -- РџРѕРєР°Р·С‹РІР°РµС‚ РЅРѕС‚РёС„РёРєР°С†РёСЋ Рѕ РЅРµСЃРѕРІРјРµСЃС‚РёРјРѕСЃС‚Рё.
        -- Р’С‹Р·С‹РІР°РµС‚СЃСЏ Р°РІС‚РѕРјР°С‚РёС‡РµСЃРєРё РїСЂРё РїРѕРїС‹С‚РєРµ РІРєР»СЋС‡РёС‚СЊ РЅРµСЃРѕРІРјРµСЃС‚РёРјСѓСЋ С„РёС‡Сѓ.
        function Library:NotifyUnsupported(featureName: string, missing: {string})
            local list = table.concat(missing, ", ")
            task.spawn(function()
                -- Р–РґС‘Рј РїРѕРєР° Notifications РёРЅРёС†РёР°Р»РёР·РёСЂСѓРµС‚СЃСЏ (РѕРЅРѕ РѕРїСЂРµРґРµР»СЏРµС‚СЃСЏ РїРѕР·Р¶Рµ РІ С„Р°Р№Р»Рµ)
                local tries = 0
                while not Notifications and tries < 20 do
                    task.wait(0.05)
                    tries += 1
                end
                if Notifications and Notifications.Create then
                    Notifications:Create({
                        Name = ('вљ  "' .. featureName .. '" вЂ” РЅРµ РїРѕРґРґРµСЂР¶РёРІР°РµС‚СЃСЏ: ' .. list),
                        LifeTime = 5,
                    })
                else
                    warn(("[Compat] Р¤РёС‡Р° '%s' РЅРµ РїРѕРґРґРµСЂР¶РёРІР°РµС‚СЃСЏ РёСЃРїРѕР»РЅРёС‚РµР»РµРј. РћС‚СЃСѓС‚СЃС‚РІСѓРµС‚: %s"):format(featureName, list))
                end
            end)
        end

        -- РћР±РѕСЂР°С‡РёРІР°РµС‚ callback С‚РѕРіРіР»Р°/С„РёС‡Рё РІ compat-РїСЂРѕРІРµСЂРєСѓ.
        -- Р•СЃР»Рё required = {"hookmetamethod"} Рё РµРіРѕ РЅРµС‚ вЂ” С„РёС‡Р° Р°РІС‚Рѕ-РІС‹РєР»СЋС‡Р°РµС‚СЃСЏ + СѓРІРµРґРѕРјР»РµРЅРёРµ.
        -- Р’РѕР·РІСЂР°С‰Р°РµС‚ РѕР±С‘СЂРЅСѓС‚С‹Р№ callback.
        function Library:CompatWrap(featureName: string, required: {string}, callback: (any) -> ()): (any) -> ()
            if not required or #required == 0 then
                return callback
            end
            return function(value: any, ...)
                -- РџСЂРѕРІРµСЂСЏРµРј С‚РѕР»СЊРєРѕ РїСЂРё РІРєР»СЋС‡РµРЅРёРё (value == true)
                if value == true then
                    local ok, missing = Library:CompatCheck(required)
                    if not ok then
                        Library:NotifyUnsupported(featureName, missing)
                        -- Р’РѕР·РІСЂР°С‰Р°РµРј sentinel С‡С‚РѕР±С‹ Toggle Р·РЅР°Р» С‡С‚Рѕ РЅР°РґРѕ РѕС‚РєР°С‚РёС‚СЊ СЃРѕСЃС‚РѕСЏРЅРёРµ
                        return "__COMPAT_BLOCKED__"
                    end
                end
    ...
    local Fonts = {}; do
        ...
        -- Р вЂ”Р В°Р С–РЎР‚РЎС“Р В·Р С”Р В° Р С”Р В°РЎР‚РЎвЂљР С‘Р Р…Р С”Р С‘ Р С—Р С• Р С—РЎР‚РЎРЏР СР С•Р в„– РЎРѓРЎРѓРЎвЂ№Р В»Р С”Р Вµ (Р В±Р ВµР В· rbxassetid, Р В±Р ВµР В· Roblox Studio)
        function Library:LoadImageFromUrl(url, filename)
            -- Р вЂњР ВµР Р…Р ВµРЎР‚Р С‘РЎР‚РЎС“Р ВµР С РЎС“Р Р…Р С‘Р С”Р В°Р В»РЎРЉР Р…Р С•Р Вµ Р С‘Р СРЎРЏ РЎвЂћР В°Р в„–Р В»Р В° Р С‘Р В· РЎРѓР В°Р СР С•Р С–Р С• URL (Р Р…Р Вµ Р Т‘Р В»Р С‘Р Р…РЎвЂ№!), РЎРѓР С•РЎвЂ¦РЎР‚Р В°Р Р…РЎРЏР ВµР С РЎР‚Р В°РЎРѓРЎв‚¬Р С‘РЎР‚Р ВµР Р…Р С‘Р Вµ
            if not filename then
                local ext = url:match("%.(%a+)%??") or "png"
                -- Р вЂР ВµРЎР‚РЎвЂР С Р С—Р С•РЎРѓР В»Р ВµР Т‘Р Р…Р С‘Р Вµ 32 РЎРѓР С‘Р СР Р†Р С•Р В»Р В° URL Р С”Р В°Р С” Р’В«Р С—РЎРѓР ВµР Р†Р Т‘Р С•РЎвЂ¦РЎРЊРЎв‚¬Р’В» РІР‚вЂќ Р С”Р С•Р В»Р В»Р С‘Р В·Р С‘Р в„– Р С—РЎР‚Р В°Р С”РЎвЂљР С‘РЎвЂЎР ВµРЎРѓР С”Р С‘ Р Р…Р ВµРЎвЂљ
                local slug = url:gsub("[^%w]", ""):sub(-32)
                filename = "petimage_" .. slug .. "." .. ext
            end
            local path = Library.Directory .. "/" .. filename
...
-- Library functions 
    -- Misc functions
        ...
        function Library:Keypicker(properties) 
            local Cfg = {
                ...
                -- Р СџР С•Р В·Р Р†Р С•Р В»РЎРЏР ВµРЎвЂљ Р В·Р В°Р Т‘Р В°РЎвЂљРЎРЉ Р С—Р С•РЎР‚РЎРЏР Т‘Р С•Р С”, Р ВµРЎРѓР В»Р С‘ Р Р…Р В° Р С•Р Т‘Р Р…Р С•Р С РЎвЂљР С•Р С–Р С–Р В»Р Вµ Р Р…Р ВµРЎРѓР С”Р С•Р В»РЎРЉР С”Р С• Р С”Р С•Р В»Р С•РЎР‚Р С—Р С‘Р С”Р ВµРЎР‚Р С•Р Р† Р С—Р С•Р Т‘РЎР‚РЎРЏР Т‘
            ...
            if Cfg.Mode == "Animation" then 
                ...
                Items.Dropdown = Index:Dropdown({Name = "Animation", Flag = Cfg.Flag .. "_ANIMATION_TYPE", Options = {"None", "Rainbow", "Fading", "Flashing"}, Default = "None"})
    ...
    -- Library element functions
        function Library:Window(properties)
            ...
            local Items = Cfg.Items; do
                ...
                -- Watermark
                    ...
                    Items.WatermarkTitle = Library:Create( "TextLabel" , {
                        ...
                        BorderColor3 = rgb(0, 0, 0);
                        RichText = true;
                        Text = "priv13 | shariktools | {build} | FPS: {fps} | Ping: {ping}";
                        Parent = Items.Watermark;
                        Name = "\0";
                        BackgroundTransparency = 1;
                        Position = dim2(0, 0, 0, -2);
                    ...
                    -- Р СџРЎР‚Р С‘Р СР ВµР Р…РЎРЏР ВµР С WatermarkText Р ВµРЎРѓР В»Р С‘ Р В·Р В°Р Т‘Р В°Р Р… Р Т‘Р С• РЎРѓР С•Р В·Р Т‘Р В°Р Р…Р С‘РЎРЏ Р С•Р С”Р Р…Р В°
                    if Library.WatermarkText and Library.WatermarkText ~= "" then
                        Library.WatermarkTemplate = Library.WatermarkText
                        Items.WatermarkTitle.Text = Library.WatermarkText
                            :gsub("{build}", Library.WatermarkIsDev and "dev" or "user")
                            :gsub("{fps}", "0")
                            :gsub("{ping}", "0ms")
                    end
                --
            ...
            function Cfg.ChangeWatermarkTitle(self, text)
                -- Р вЂўРЎРѓР В»Р С‘ Р Р†РЎвЂ№Р В·Р Р†Р В°Р Р…Р В° Р С”Р В°Р С” Window:ChangeWatermarkTitle(text), self Р В±РЎС“Р Т‘Р ВµРЎвЂљ РЎвЂљР В°Р В±Р В»Р С‘РЎвЂ Р В° Window
                -- Р вЂўРЎРѓР В»Р С‘ Р Р†РЎвЂ№Р В·Р Р†Р В°Р Р…Р В° Р С”Р В°Р С” РЎвЂћРЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ, self Р В±РЎС“Р Т‘Р ВµРЎвЂљ РЎвЂљР ВµР С”РЎРѓРЎвЂљ
                ...
                -- Р вЂўРЎРѓР В»Р С‘ РЎвЂљР ВµР С”РЎРѓРЎвЂљ РЎРѓР С•Р Т‘Р ВµРЎР‚Р В¶Р С‘РЎвЂљ Р С—Р В»Р ВµР в„–РЎРѓРЎвЂ¦Р С•Р В»Р Т‘Р ВµРЎР‚РЎвЂ№ РІР‚вЂќ Р В·Р В°Р С—РЎС“РЎРѓР С”Р В°Р ВµР С РЎР‚Р ВµР В°Р В»-РЎвЂљР В°Р в„–Р С Р С•Р В±Р Р…Р С•Р Р†Р В»Р ВµР Р…Р С‘Р Вµ
                if text:find("{fps}") or text:find("{ping}") or text:find("{build}") then
                    if not Library.WatermarkUpdating then
                        Library.WatermarkUpdating = true
                        ...
                        RunService.RenderStepped:Connect(function()
                            ...
                            -- Р С›Р В±Р Р…Р С•Р Р†Р В»РЎРЏР ВµР С FPS РЎР‚Р В°Р В· Р Р† 10 Р С”Р В°Р Т‘РЎР‚Р С•Р Р†
                            if frameCount >= 10 then
                                local currentTime = tick()
                                Library.WatermarkLastFPS = math.floor(10 / (currentTime - lastTime))
                            ...
                            pcall(function()
                                ...
                                Library.WatermarkLastPing = math.floor(ping * 1000)
                            end)
                            
                            -- Р В¤Р С•РЎР‚Р СР В°РЎвЂљР С‘РЎР‚РЎС“Р ВµР С РЎвЂљР ВµР С”РЎРѓРЎвЂљ
                            local result = Library.WatermarkTemplate
                            result = result:gsub("{build}", Library.WatermarkIsDev and "dev" or "user")
                            result = result:gsub("{fps}", tostring(Library.WatermarkLastFPS))
                            result = result:gsub("{ping}", tostring(Library.WatermarkLastPing) .. "ms")
                            
                            Items.WatermarkTitle.Text = result
                        end)
                    end
                else
                    -- Р вЂР ВµР В· Р С—Р В»Р ВµР в„–РЎРѓРЎвЂ¦Р С•Р В»Р Т‘Р ВµРЎР‚Р С•Р Р† РІР‚вЂќ Р С—РЎР‚Р С•РЎРѓРЎвЂљР С• Р С•Р В±Р Р…Р С•Р Р†Р В»РЎРЏР ВµР С РЎвЂљР ВµР С”РЎРѓРЎвЂљ
                    local result = text
                    result = result:gsub("{build}", Library.WatermarkIsDev and "dev" or "user")
                    Items.WatermarkTitle.Text = result
                end
            ...
            -- Р вЂ”Р В°Р С—РЎС“РЎРѓР С”Р В°Р ВµР С Р Т‘Р С‘Р Р…Р В°Р СР С‘РЎвЂЎР ВµРЎРѓР С”Р С•Р Вµ Р С•Р В±Р Р…Р С•Р Р†Р В»Р ВµР Р…Р С‘Р Вµ Р ВµРЎРѓР В»Р С‘ WatermarkText Р В·Р В°Р Т‘Р В°Р Р… Р Т‘Р С• Library:Window()
            if Library.WatermarkText and Library.WatermarkText ~= "" then
                Cfg.ChangeWatermarkTitle(Cfg, Library.WatermarkText)
            end
        ...
        function Library:Toggle(properties) 
            -- РћР±РѕСЂР°С‡РёРІР°РµРј callback РІ compat-РїСЂРѕРІРµСЂРєСѓ РµСЃР»Рё СѓРєР°Р·Р°РЅ Requires
            local rawCallback = properties.Callback or function() end
            local wrappedCallback = rawCallback
            if properties.Requires and #properties.Requires > 0 then
                wrappedCallback = Library:CompatWrap(
                    properties.Name or "Toggle",
                    properties.Requires,
                    rawCallback
                )
            end
            ...
            function Cfg.Set(bool)
                local result = Cfg.Callback(bool)

                -- Р•СЃР»Рё compat-РІСЂР°РїРїРµСЂ Р·Р°Р±Р»РѕРєРёСЂРѕРІР°Р» РІРєР»СЋС‡РµРЅРёРµ вЂ” РѕС‚РєР°С‚С‹РІР°РµРј СЃРѕСЃС‚РѕСЏРЅРёРµ
                if result == "__COMPAT_BLOCKED__" then
                    Cfg.Enabled = false
                    Flags[Cfg.Flag] = false
                    Library:Tween(Items.Accent, {BackgroundColor3 = themes.preset.inline})
                    if Cfg.Folding then
        ...
        function Library:Configs(window) 
            ...
            window.Tweening = true
            Section:Label({Name = "Menu Bind"}):Keybind({Name = "Menu Bind", ShowInList = false, Key = Enum.KeyCode.RightAlt, Callback = function(bool) 
                ...
                -- Р вЂўРЎРѓР В»Р С‘ Р Р†Р С”Р В»РЎР‹РЎвЂЎР ВµР Р…Р В° Р Р…Р В°РЎРѓРЎвЂљРЎР‚Р С•Р в„–Р С”Р В° "Pet Follows Menu" РІР‚вЂќ Р С”Р С•РЎвЂљ Р С—РЎР‚РЎРЏРЎвЂЎР ВµРЎвЂљРЎРѓРЎРЏ/Р С—Р С•РЎРЏР Р†Р В»РЎРЏР ВµРЎвЂљРЎРѓРЎРЏ Р Р†Р СР ВµРЎРѓРЎвЂљР Вµ РЎРѓ Р В»Р С‘Р В±Р С•Р в„–,
                -- Р СњР С› РЎвЂљР С•Р В»РЎРЉР С”Р С• Р ВµРЎРѓР В»Р С‘ Р С—Р С•Р В»РЎРЉР В·Р С•Р Р†Р В°РЎвЂљР ВµР В»РЎРЉ Р Т‘Р С• РЎРЊРЎвЂљР С•Р С–Р С• Р Р…Р Вµ Р Р†РЎвЂ№Р С”Р В»РЎР‹РЎвЂЎР С‘Р В» Р ВµР С–Р С• Р Р†РЎР‚РЎС“РЎвЂЎР Р…РЎС“РЎР‹ РЎвЂЎР ВµРЎР‚Р ВµР В· РЎвЂљР С•Р С–Р С–Р В» "Pet Panel"
                if Library.PetFollowsMenu and Library.PetPanelInstance and (bool == false or Library.PetPanelInstance.UserEnabled) then
                    Library.PetPanelInstance.ToggleVisible(bool)
                end
            end, Default = true})
            ...
            Section:Toggle({Name = "Pet Panel", Flag = "PetPanel", Default = (Library.PetPanelInstance ~= nil), Callback = function(state)
                if Library.PetPanelInstance then
                    Library.PetPanelInstance.ToggleVisible(state, true)
                end
            end})
            Section:Toggle({Name = "Pet Follows Menu", Flag = "PetFollowsMenu", Default = true, Callback = function(state)
                Library.PetFollowsMenu = state
            end})
            Section:Textbox({Name = "Custom Menu Name", Callback = window.ChangeTitle, Default = window.Name, Placeholder = "Title name here..."})
            Section:Textbox({Name = "Custom Watermark Name", Callback = window.ChangeWatermarkTitle, Default = "priv13 | shariktools | {build} | FPS: {fps} | Ping: {ping}", Placeholder = "Title name here..."})
    ...
    -- Pet Panel (Р С”Р В°РЎРѓРЎвЂљР С•Р СР Р…Р В°РЎРЏ Р В·Р В°РЎвЂ¦Р В°РЎР‚Р Т‘Р С”Р С•Р В¶Р ВµР Р…Р Р…Р В°РЎРЏ Р С—Р В°Р Р…Р ВµР В»РЎРЉ РЎРѓ Р С”Р В°РЎР‚РЎвЂљР С‘Р Р…Р С”Р С•Р в„–)
        function Library:PetPanel(properties)
            local Cfg = {
                Enabled = (properties and properties.Enabled) or false; -- <-- РЎРѓРЎР‹Р Т‘Р В° true/false, РЎвЂ¦Р В°РЎР‚Р Т‘Р С”Р С•Р Т‘ Р Р†Р С”Р В»/Р Р†РЎвЂ№Р С”Р В»
                Image = (properties and properties.Image) or "";       -- <-- rbxassetid:// Р С”Р В°РЎР‚РЎвЂљР С‘Р Р…Р С”Р С‘ (Р ВµРЎРѓР В»Р С‘ Р С–РЎР‚РЎС“Р В·Р С‘РЎв‚¬РЎРЉ РЎвЂЎР ВµРЎР‚Р ВµР В· Studio)
                ImageUrl = (properties and properties.ImageUrl) or nil; -- <-- Р С—РЎР‚РЎРЏР СР В°РЎРЏ РЎРѓРЎРѓРЎвЂ№Р В»Р С”Р В° Р Р…Р В° Р С”Р В°РЎР‚РЎвЂљР С‘Р Р…Р С”РЎС“ (Р ВµРЎРѓР В»Р С‘ РЎвЂ¦Р С•РЎвЂЎР ВµРЎв‚¬РЎРЉ Р В±Р ВµР В· Studio)
                Images = (properties and properties.Images) or nil;    -- <-- Р СР В°РЎРѓРЎРѓР С‘Р Р† Р С”Р В°РЎР‚РЎвЂљР С‘Р Р…Р С•Р С” Р Т‘Р В»РЎРЏ Р В»Р С‘РЎРѓРЎвЂљР В°Р Р…Р С‘РЎРЏ: {"https://...", "rbxassetid://...", ...}
                Name = (properties and properties.Name) or "Sharik";

                -- Р  Р ВµР В°Р В»РЎРЉР Р…РЎвЂ№Р Вµ Р С—РЎР‚Р С•Р С—Р С•РЎР‚РЎвЂ Р С‘Р С‘ Р С”Р В°РЎР‚РЎвЂљР С‘Р Р…Р С”Р С‘ (РЎв‚¬Р С‘РЎР‚Р С‘Р Р…Р В°/Р Р†РЎвЂ№РЎРѓР С•РЎвЂљР В° Р С‘РЎРѓРЎвЂ¦Р С•Р Т‘Р Р…Р С•Р С–Р С• РЎвЂћР В°Р в„–Р В»Р В°).
                -- Р СџР С• РЎС“Р СР С•Р В»РЎвЂЎР В°Р Р…Р С‘РЎР‹ РЎвЂљРЎС“РЎвЂљ РЎР‚Р В°Р В·Р СР ВµРЎР‚РЎвЂ№ РЎвЂљР Р†Р С•Р ВµР С–Р С• РЎвЂћР С•РЎвЂљР С• РЎв‚¬Р В°РЎР‚Р С‘Р С”Р В°: 720x934
                ImageWidth = (properties and properties.ImageWidth) or 720;
                ImageHeight = (properties and properties.ImageHeight) or 934;

                -- Р вЂ”Р В°Р Т‘Р В°РЎвЂРЎв‚¬РЎРЉ РЎвЂљР С•Р В»РЎРЉР С”Р С• РЎв‚¬Р С‘РЎР‚Р С‘Р Р…РЎС“ Р С•Р С”Р Р…Р В° РІР‚вЂќ Р Р†РЎвЂ№РЎРѓР С•РЎвЂљР В° Р С—Р С•РЎРѓРЎвЂЎР С‘РЎвЂљР В°Р ВµРЎвЂљРЎРѓРЎРЏ РЎРѓР В°Р СР В° Р С—Р С•Р Т‘ Р С—РЎР‚Р С•Р С—Р С•РЎР‚РЎвЂ Р С‘Р С‘ Р С”Р В°РЎР‚РЎвЂљР С‘Р Р…Р С”Р С‘
                Width = (properties and properties.Width) or 220;

                -- Р СџРЎР‚Р С‘Р Р†РЎРЏР В·Р С”Р В° Р С” Р С–Р В»Р В°Р Р†Р Р…Р С•Р СРЎС“ Р С•Р С”Р Р…РЎС“ Р В±Р С‘Р В±Р В»Р С‘Р С•РЎвЂљР ВµР С”Р С‘ (Р С—Р ВµРЎР‚Р ВµР Т‘Р В°Р в„– РЎРѓРЎР‹Р Т‘Р В° Р С•Р В±РЎР‰Р ВµР С”РЎвЂљ window, Р С”Р С•РЎвЂљР С•РЎР‚РЎвЂ№Р в„– Р Р†Р ВµРЎР‚Р Р…РЎС“Р В» Library:Window)
                AnchorWindow = (properties and properties.AnchorWindow) or nil;
                Side = (properties and properties.Side) or "Left"; -- "Left" Р С‘Р В»Р С‘ "Right" Р С•РЎвЂљ Р С–Р В»Р В°Р Р†Р Р…Р С•Р С–Р С• Р С•Р С”Р Р…Р В°
                Gap = (properties and properties.Gap) or 8;        -- Р С•РЎвЂљРЎРѓРЎвЂљРЎС“Р С— Р СР ВµР В¶Р Т‘РЎС“ Р С•Р С”Р Р…Р В°Р СР С‘ Р Р† Р С—Р С‘Р С”РЎРѓР ВµР В»РЎРЏРЎвЂ¦
                AlignY = (properties and properties.AlignY) or "Top"; -- "Top" Р С‘Р В»Р С‘ "Center" Р С—Р С• Р Р†Р ВµРЎР‚РЎвЂљР С‘Р С”Р В°Р В»Р С‘
            }

            -- Р вЂўРЎРѓР В»Р С‘ Images Р Р…Р Вµ Р В·Р В°Р Т‘Р В°Р Р… РІР‚вЂќ РЎРѓР С•Р В±Р С‘РЎР‚Р В°Р ВµР С Р ВµР С–Р С• Р С‘Р В· РЎРѓРЎвЂљР В°РЎР‚РЎвЂ№РЎвЂ¦ Image/ImageUrl (Р С•Р В±РЎР‚Р В°РЎвЂљР Р…Р В°РЎРЏ РЎРѓР С•Р Р†Р СР ВµРЎРѓРЎвЂљР С‘Р СР С•РЎРѓРЎвЂљРЎРЉ)
            if not Cfg.Images then
                if Cfg.ImageUrl then
                    Cfg.Images = {Cfg.ImageUrl}
                elseif Cfg.Image ~= "" then
            ...
            local AspectRatio = Cfg.ImageWidth / Cfg.ImageHeight
            local ContentWidth = Cfg.Width
            local ContentHeight = math.floor(ContentWidth / AspectRatio)

            -- Р СџР С•Р В»Р Р…Р В°РЎРЏ Р Р†РЎвЂ№РЎРѓР С•РЎвЂљР В° Р С•Р С”Р Р…Р В° = Р С”Р В°РЎР‚РЎвЂљР С‘Р Р…Р С”Р В° + РЎв‚¬Р В°Р С—Р С”Р В° (16) + Р Р†Р Р…РЎС“РЎвЂљРЎР‚Р ВµР Р…Р Р…Р С‘Р Вµ Р С•РЎвЂљРЎРѓРЎвЂљРЎС“Р С—РЎвЂ№ РЎР‚Р В°Р СР С•Р С” (~9)
            local FrameExtraHeight = 25
            local FrameExtraWidth = 10

            Cfg.Size = vec2(ContentWidth + FrameExtraWidth, ContentHeight + FrameExtraHeight)
            ...
            -- Р РЋРЎвЂЎР С‘РЎвЂљР В°Р ВµР С Р С—Р С•Р В·Р С‘РЎвЂ Р С‘РЎР‹: Р В»Р С‘Р В±Р С• РЎР‚РЎРЏР Т‘Р С•Р С РЎРѓ Р С–Р В»Р В°Р Р†Р Р…РЎвЂ№Р С Р С•Р С”Р Р…Р С•Р С Р В»Р С‘Р В±РЎвЂ№, Р В»Р С‘Р В±Р С• Р С—Р С• РЎвЂ Р ВµР Р…РЎвЂљРЎР‚РЎС“ РЎРЊР С”РЎР‚Р В°Р Р…Р В° (fallback)
            local StartPosition
            do
                local MainWindow = Cfg.AnchorWindow and Cfg.AnchorWindow.Items and Cfg.AnchorWindow.Items.Window

                if MainWindow then
                    local mx, my = MainWindow.Position.X.Offset, MainWindow.Position.Y.Offset
                    local mw, mh = MainWindow.Size.X.Offset, MainWindow.Size.Y.Offset

                    local x
                    if Cfg.Side == "Right" then
                        x = mx + mw + Cfg.Gap
                    else -- "Left"
                        x = mx - Cfg.Size.X - Cfg.Gap
                    end

                    local y
                    if Cfg.AlignY == "Center" then
                        y = my + (mh / 2) - (Cfg.Size.Y / 2)
                    else -- "Top"
                        y = my
                    end
                    ...
                    StartPosition = dim2(0.5, -Cfg.Size.X / 2, 0.5, -Cfg.Size.Y / 2)
                end
            end

            -- Window (Р Р†Р Р…Р ВµРЎв‚¬Р Р…РЎРЏРЎРЏ РЎР‚Р В°Р СР С”Р В°) РІР‚вЂќ РЎвЂљР С•РЎвЂљ Р В¶Р Вµ Р С—Р В°РЎвЂљРЎвЂљР ВµРЎР‚Р Р… РЎвЂЎРЎвЂљР С• РЎС“ Library:Window
            Items.Window = Library:Create("Frame", {
                Parent = Items.Gui;
                Name = "\0";
                Position = StartPosition;
                BorderColor3 = rgb(0, 0, 0);
                Size = dim2(0, Cfg.Size.X, 0, Cfg.Size.Y);
                BorderSizePixel = 0;
                BackgroundColor3 = themes.preset.outline;
            ...
            -- Р РЋР С‘Р Р…РЎРЏРЎРЏ Р В°Р С”РЎвЂ Р ВµР Р…РЎвЂљ-Р С—Р С•Р В»Р С•РЎРѓР С”Р В° РЎРѓР Р†Р ВµРЎР‚РЎвЂ¦РЎС“ Р С•Р С”Р Р…Р В°, Р С”Р В°Р С” РЎС“ Р С–Р В»Р В°Р Р†Р Р…Р С•Р С–Р С• Р С•Р С”Р Р…Р В° Р В±Р С‘Р В±Р В»Р С‘Р С•РЎвЂљР ВµР С”Р С‘
            Items.Accent = Library:Create("Frame", {
                Parent = Items.Window;
                Name = "\0";
                Position = dim2(0, 1, 0, 1);
            ...
            -- Р вЂ™Р ВµРЎР‚РЎвЂ¦Р Р…РЎРЏРЎРЏ Р С—Р С•Р В»Р С•РЎРѓР С”Р В° РЎРѓ Р С–РЎР‚Р В°Р Т‘Р С‘Р ВµР Р…РЎвЂљР С•Р С (Р В°Р С”РЎвЂ Р ВµР Р…РЎвЂљ/Р В·Р В°Р С–Р С•Р В»Р С•Р Р†Р С•Р С”), Р С”Р В°Р С” РЎв‚¬Р В°Р С—Р С”Р В° Р С•РЎРѓР Р…Р С•Р Р†Р Р…Р С•Р С–Р С• Р С•Р С”Р Р…Р В°
            ...
            local topGradient = Library:Create("UIGradient", {
                ...
                Parent = Items.TopBar;
                Color = rgbseq{rgbkey(0, themes.preset.inline), rgbkey(1, themes.preset.gradient)};
            }); Library:SaveGradient(topGradient, "Selected")
            ...
            -- Р С™Р Р…Р С•Р С—Р С”Р В° Р В·Р В°Р С”РЎР‚РЎвЂ№РЎвЂљР С‘РЎРЏ Р С—Р В°Р Р…Р ВµР В»Р С‘ (Р С—РЎР‚РЎРЏРЎвЂЎР ВµРЎвЂљ Р С–РЎС“Р С‘ Р Р† РЎРЊРЎвЂљР С•Р в„– РЎРѓР ВµРЎРѓРЎРѓР С‘Р С‘; Р С—Р С•Р В»Р Р…Р С•РЎРѓРЎвЂљРЎРЉРЎР‹ Р Р†РЎвЂ№Р С”Р В»РЎР‹РЎвЂЎР В°Р ВµРЎвЂљРЎРѓРЎРЏ РЎвЂћР В»Р В°Р С–Р С•Р С Enabled)
            ...
            Library:Connection(Items.CloseBtn.MouseButton1Click, function()
                Items.ToggleVisible(false, true)
            end)

            -- Р вЂ™Р Р…РЎС“РЎвЂљРЎР‚Р ВµР Р…Р Р…РЎРЏРЎРЏ РЎР‚Р В°Р СР С”Р В° (outline -> background), Р С”Р В°Р С” РЎС“ Window
            Items.InnerOutline = Library:Create("Frame", {
                ...
                BorderSizePixel = 0;
                BackgroundColor3 = themes.preset.outline;
            }); Library:Themify(Items.InnerOutline, "outline", "BackgroundColor3")
            ...
            -- ===== Р вЂњР В°Р В»Р ВµРЎР‚Р ВµРЎРЏ (Р В»Р С‘РЎРѓРЎвЂљР В°Р Р…Р С‘Р Вµ Р Р…Р ВµРЎРѓР С”Р С•Р В»РЎРЉР С”Р С‘РЎвЂ¦ Р С”Р В°РЎР‚РЎвЂљР С‘Р Р…Р С•Р С”) =====
            do
                -- ImageCache[i] = РЎРѓРЎвЂљРЎР‚Р С•Р С”Р В°-asset Р С—Р С•РЎРѓР В»Р Вµ Р В·Р В°Р С–РЎР‚РЎС“Р В·Р С”Р С‘, false = Р ВµРЎвЂ°РЎвЂ Р С–РЎР‚РЎС“Р В·Р С‘РЎвЂљРЎРѓРЎРЏ, nil = Р Р…Р Вµ Р Р…Р В°РЎвЂЎР В°РЎвЂљР С•
                local ImageCache = {}
                ...
                local function ResolveImage(src)
                    ...
                    if src:sub(1, 4) == "http" then
                        local loaded = Library:LoadImageFromUrl(src)
                        return loaded or ""
                    end
                    return src -- РЎС“Р В¶Р Вµ rbxassetid:// Р С‘Р В»Р С‘ Р С–Р С•РЎвЂљР С•Р Р†РЎвЂ№Р в„– asset
                end

                -- Р вЂ”Р В°Р С—РЎС“РЎРѓР С”Р В°Р ВµР С РЎвЂћР С•Р Р…Р С•Р Р†РЎС“РЎР‹ Р В·Р В°Р С–РЎР‚РЎС“Р В·Р С”РЎС“ Р Т‘Р В»РЎРЏ Р С•Р Т‘Р Р…Р С•Р С–Р С• Р С‘Р Р…Р Т‘Р ВµР С”РЎРѓР В°
                local function PrefetchIndex(i)
                    if ImageCache[i] ~= nil then return end -- РЎС“Р В¶Р Вµ Р С–РЎР‚РЎС“Р В·Р С‘РЎвЂљРЎРѓРЎРЏ Р С‘Р В»Р С‘ Р С–Р С•РЎвЂљР С•Р Р†Р С•
                    ImageCache[i] = false -- Р СР В°РЎР‚Р С”Р ВµРЎР‚ Р’В«Р Р† Р С—РЎР‚Р С•РЎвЂ Р ВµРЎРѓРЎРѓР ВµР’В»
                    task.spawn(function()
                        local result = ResolveImage(Cfg.Images[i])
                        ImageCache[i] = result
                        -- Р ВµРЎРѓР В»Р С‘ РЎРЊРЎвЂљР С• РЎвЂљР ВµР С”РЎС“РЎвЂ°Р В°РЎРЏ Р С”Р В°РЎР‚РЎвЂљР С‘Р Р…Р С”Р В° РІР‚вЂќ Р С—РЎР‚Р С‘Р СР ВµР Р…РЎРЏР ВµР С РЎРѓРЎР‚Р В°Р В·РЎС“ Р С”Р В°Р С” Р В·Р В°Р С–РЎР‚РЎС“Р В·Р С‘Р В»Р В°РЎРѓРЎРЉ
                        if i == CurrentIndex and Items.Image and Items.Image.Parent then
                            Items.Image.Image = result
                        end
                    end)
                end

                -- Р СџРЎР‚Р ВµР С–РЎР‚РЎС“Р В¶Р В°Р ВµР С Р вЂ™Р РЋР вЂў Р С”Р В°РЎР‚РЎвЂљР С‘Р Р…Р С”Р С‘ Р С—Р В°РЎР‚Р В°Р В»Р В»Р ВµР В»РЎРЉР Р…Р С• Р С—РЎР‚Р С‘ РЎРѓР С•Р В·Р Т‘Р В°Р Р…Р С‘Р С‘ Р С—Р В°Р Р…Р ВµР В»Р С‘
                for i = 1, #Cfg.Images do
                    PrefetchIndex(i)
                end

                local function ShowImage(index)
                    local total = #Cfg.Images
                    ...
                    local cached = ImageCache[CurrentIndex]
                    if cached and cached ~= false then
                        -- Р Р€Р В¶Р Вµ Р С–Р С•РЎвЂљР С•Р Р†Р С• РІР‚вЂќ Р С—РЎР‚Р С‘Р СР ВµР Р…РЎРЏР ВµР С Р СР С–Р Р…Р С•Р Р†Р ВµР Р…Р Р…Р С•
                        Items.Image.Image = cached
                    elseif cached == false then
                        -- Р вЂўРЎвЂ°РЎвЂ Р С–РЎР‚РЎС“Р В·Р С‘РЎвЂљРЎРѓРЎРЏ РІР‚вЂќ РЎРѓРЎвЂљР В°Р Р†Р С‘Р С Р С—РЎС“РЎРѓРЎвЂљРЎвЂ№РЎв‚¬Р С”РЎС“, Р С–РЎР‚РЎС“Р В·РЎвЂЎР С‘Р С” РЎРѓР В°Р С Р С•Р В±Р Р…Р С•Р Р†Р С‘РЎвЂљ Р С”Р С•Р С–Р Т‘Р В° Р В·Р В°Р С”Р С•Р Р…РЎвЂЎР С‘РЎвЂљ
                        Items.Image.Image = ""
                    else
                        -- Р вЂ™Р Т‘РЎР‚РЎС“Р С– Р Р…Р Вµ Р В·Р В°Р С—РЎС“РЎвЂ°Р ВµР Р…Р С• (Р Р…Р В° Р Р†РЎРѓРЎРЏР С”Р С‘Р в„– РЎРѓР В»РЎС“РЎвЂЎР В°Р в„–)
                        PrefetchIndex(CurrentIndex)
                        Items.Image.Image = ""
                    end

                    if Items.PageLabel then
                        Items.PageLabel.Text = CurrentIndex .. "/" .. total
                    end
                end

                Items.ShowImage = ShowImage
                Items.NextImage = function() ShowImage(CurrentIndex + 1) end
                Items.PrevImage = function() ShowImage(CurrentIndex - 1) end

                -- Р С™Р Р…Р С•Р С—Р С”Р С‘ Р В»Р С‘РЎРѓРЎвЂљР В°Р Р…Р С‘РЎРЏ Р С‘ РЎРѓРЎвЂЎРЎвЂРЎвЂљРЎвЂЎР С‘Р С” РЎРѓРЎвЂљРЎР‚Р В°Р Р…Р С‘РЎвЂ  Р С—Р С•Р С”Р В°Р В·РЎвЂ№Р Р†Р В°Р ВµР С РЎвЂљР С•Р В»РЎРЉР С”Р С• Р ВµРЎРѓР В»Р С‘ Р С”Р В°РЎР‚РЎвЂљР С‘Р Р…Р С•Р С” Р В±Р С•Р В»РЎРЉРЎв‚¬Р Вµ Р С•Р Т‘Р Р…Р С•Р в„–
                if #Cfg.Images > 1 then
                    Items.PrevBtn = Library:Create("TextButton", {
                        FontFace = Library.Font;
                        Parent = Items.Background;
                        Text = "<";
                        TextColor3 = rgb(255, 255, 255);
                    ...
                    Items.NextBtn = Library:Create("TextButton", {
                        FontFace = Library.Font;
                        Parent = Items.Background;
                        Text = ">";
                        TextColor3 = rgb(255, 255, 255);
                    ...
                    Items.PageLabel = Library:Create("TextLabel", {
                        FontFace = Library.Font;
                        Parent = Items.Background;
                        Text = "1/" .. #Cfg.Images;
                        TextColor3 = rgb(255, 255, 255);
                    ...
                    Library:Connection(Items.PrevBtn.MouseButton1Click, Items.PrevImage)
                    Library:Connection(Items.NextBtn.MouseButton1Click, Items.NextImage)
                end

                ShowImage(1)
            end

            -- Р вЂќРЎР‚Р В°Р С– Р В·Р В° Р Р†Р ВµРЎР‚РЎвЂ¦Р Р…РЎР‹РЎР‹ Р С—Р С•Р В»Р С•РЎРѓР С”РЎС“
            do
                local dragging = false
                local dragStart, startPos

                Library:Connection(Items.TopBar.InputBegan, function(input)
            ...
            -- Р СџР В»Р В°Р Р†Р Р…Р С•Р Вµ РЎРѓР С”РЎР‚РЎвЂ№РЎвЂљР С‘Р Вµ/Р С—Р С•Р С”Р В°Р В·, Р С”Р В°Р С” РЎС“ Р С–Р В»Р В°Р Р†Р Р…Р С•Р С–Р С• Р СР ВµР Р…РЎР‹ (ToggleMenu) РІР‚вЂќ РЎвЂћР ВµР в„–Р Т‘Р С‘РЎвЂљ Р Р†РЎРѓР Вµ Р Т‘Р С•РЎвЂЎР ВµРЎР‚Р Р…Р С‘Р Вµ Р С•Р В±РЎР‰Р ВµР С”РЎвЂљРЎвЂ№
            -- UserEnabled РІР‚вЂќ Р С‘РЎРѓРЎвЂљР С‘Р Р…Р Р…Р С•Р Вµ Р Р…Р В°Р СР ВµРЎР‚Р ВµР Р…Р С‘Р Вµ Р С—Р С•Р В»РЎРЉР В·Р С•Р Р†Р В°РЎвЂљР ВµР В»РЎРЏ (РЎвЂљР С•Р С–Р С–Р В» "Pet Panel" Р Р† Р Р…Р В°РЎРѓРЎвЂљРЎР‚Р С•Р в„–Р С”Р В°РЎвЂ¦).
            -- ToggleVisible(state, isUserAction) РІР‚вЂќ isUserAction=true Р В·Р Р…Р В°РЎвЂЎР С‘РЎвЂљ "Р С—Р С•Р В»РЎРЉР В·Р С•Р Р†Р В°РЎвЂљР ВµР В»РЎРЉ РЎРЏР Р†Р Р…Р С• РЎвЂ°РЎвЂР В»Р С”Р Р…РЎС“Р В» РЎвЂљР С•Р С–Р С–Р В»",
            -- Р В° Р Р…Р Вµ "Р СР ВµР Р…РЎР‹ Р С—РЎР‚Р С•РЎРѓРЎвЂљР С• Р С•РЎвЂљР С”РЎР‚РЎвЂ№Р В»Р С•РЎРѓРЎРЉ/Р В·Р В°Р С”РЎР‚РЎвЂ№Р В»Р С•РЎРѓРЎРЉ" РІР‚вЂќ РЎРЊРЎвЂљР С• Р Р…РЎС“Р В¶Р Р…Р С•, РЎвЂЎРЎвЂљР С•Р В±РЎвЂ№ Р В±Р С‘Р Р…Р Т‘ Р СР ВµР Р…РЎР‹ Р Р…Р Вµ Р Р†Р С”Р В»РЎР‹РЎвЂЎР В°Р В» Р С”Р С•РЎвЂљР В° Р С•Р В±РЎР‚Р В°РЎвЂљР Р…Р С•,
            -- Р ВµРЎРѓР В»Р С‘ Р С—Р С•Р В»РЎРЉР В·Р С•Р Р†Р В°РЎвЂљР ВµР В»РЎРЉ Р Т‘Р С• РЎРЊРЎвЂљР С•Р С–Р С• Р Р†РЎвЂ№Р С”Р В»РЎР‹РЎвЂЎР С‘Р В» Р ВµР С–Р С• Р Р†РЎР‚РЎС“РЎвЂЎР Р…РЎС“РЎР‹.
            Items.UserEnabled = true
            Items.Tweening = false
            Items.ToggleVisible = function(state, isUserAction)
                if isUserAction then
                    Items.UserEnabled = state
                end

                if Items.Tweening then
                    return
                end
                ...
                for _, obj in Children do
                    ...
                    if type(Index) == "table" then
                        for _, prop in Index do
                            Tween = Library:Fade(obj, prop, state)
                        end
                    else
                        Tween = Library:Fade(obj, Index, state)
                    end
                end
            ...
            Library.PetPanelInstance = Items

            return Items
        end
    --

    -- Update Log (Р С•Р Т‘Р Р…Р С•РЎР‚Р В°Р В·Р С•Р Р†Р С•Р Вµ Р С•Р С”Р Р…Р С• РЎРѓ Р В»Р С•Р С–Р С•Р С Р С‘Р В·Р СР ВµР Р…Р ВµР Р…Р С‘Р в„–, Р С—Р С•Р С”Р В°Р В·РЎвЂ№Р Р†Р В°Р ВµРЎвЂљРЎРѓРЎРЏ Р С—РЎР‚Р С‘ Р В·Р В°Р С—РЎС“РЎРѓР С”Р Вµ РЎРѓР С”РЎР‚Р С‘Р С—РЎвЂљР В°)
        function Library:UpdateLog(properties)
            local Cfg = {
                Title = (properties and properties.Title) or "Update Log";
                Entries = (properties and properties.Entries) or {}; -- Р СР В°РЎРѓРЎРѓР С‘Р Р† РЎРѓРЎвЂљРЎР‚Р С•Р С”: {"+ Р вЂќР С•Р В±Р В°Р Р†Р С‘Р В»Р С‘ X", "- Р Р€Р В±РЎР‚Р В°Р В»Р С‘ Y", "~ Р СџР С•РЎвЂЎР С‘Р Р…Р С‘Р В»Р С‘ Z"}
                Width = (properties and properties.Width) or 260;

                -- Р вЂўРЎРѓР В»Р С‘ Height Р Р…Р Вµ Р В·Р В°Р Т‘Р В°Р Р… РЎРЏР Р†Р Р…Р С• РІР‚вЂќ Р Р†РЎвЂ№РЎРѓР С•РЎвЂљР В° Р С—Р С•РЎРѓРЎвЂЎР С‘РЎвЂљР В°Р ВµРЎвЂљРЎРѓРЎРЏ РЎРѓР В°Р СР В° Р С—Р С•Р Т‘ Р С•Р В±РЎР‰РЎвЂР С РЎвЂљР ВµР С”РЎРѓРЎвЂљР В° (Р Р† Р С—РЎР‚Р ВµР Т‘Р ВµР В»Р В°РЎвЂ¦ MinHeight/MaxHeight).
                -- Р вЂўРЎРѓР В»Р С‘ Р В·Р В°Р Т‘Р В°Р Р… РІР‚вЂќ Р С•Р С”Р Р…Р С• РЎвЂћР С‘Р С”РЎРѓР С‘РЎР‚Р С•Р Р†Р В°Р Р…Р Р…Р С•Р в„– Р Р†РЎвЂ№РЎРѓР С•РЎвЂљРЎвЂ№, Р С”Р В°Р С” РЎР‚Р В°Р Р…РЎРЉРЎв‚¬Р Вµ, РЎРѓ Р С—РЎР‚Р С•Р С”РЎР‚РЎС“РЎвЂљР С”Р С•Р в„– Р С—РЎР‚Р С‘ Р С—Р ВµРЎР‚Р ВµР С—Р С•Р В»Р Р…Р ВµР Р…Р С‘Р С‘.
                Height = (properties and properties.Height) or nil;
                MinHeight = (properties and properties.MinHeight) or 70;
                MaxHeight = (properties and properties.MaxHeight) or 320;

                -- Р СџРЎР‚Р С‘Р Р†РЎРЏР В·Р С”Р В° Р С” Р С–Р В»Р В°Р Р†Р Р…Р С•Р СРЎС“ Р С•Р С”Р Р…РЎС“ Р В±Р С‘Р В±Р В»Р С‘Р С•РЎвЂљР ВµР С”Р С‘, Р С”Р В°Р С” РЎС“ PetPanel (Р Р…Р ВµР С•Р В±РЎРЏР В·Р В°РЎвЂљР ВµР В»РЎРЉР Р…Р С•)
                AnchorWindow = (properties and properties.AnchorWindow) or nil;
            ...
            local AutoHeight = Cfg.Height == nil
            local ChromeHeight = 44 -- РЎРѓР С”Р С•Р В»РЎРЉР С”Р С• Р С—Р С‘Р С”РЎРѓР ВµР В»Р ВµР в„– Р Р†РЎвЂ№РЎРѓР С•РЎвЂљРЎвЂ№ Р С•Р С”Р Р…Р В° РЎС“РЎвЂ¦Р С•Р Т‘Р С‘РЎвЂљ Р Р…Р В° РЎв‚¬Р В°Р С—Р С”РЎС“/РЎР‚Р В°Р СР С”Р С‘/Р С—Р В°Р Т‘Р Т‘Р С‘Р Р…Р С–Р С‘ (Р Р…Р Вµ Р С—Р С•Р Т‘ РЎвЂљР ВµР С”РЎРѓРЎвЂљ)

            -- Р РЋРЎвЂљР В°РЎР‚РЎвЂљР С•Р Р†Р В°РЎРЏ Р Р†РЎвЂ№РЎРѓР С•РЎвЂљР В° (Р С—Р С•Р С”Р В° Р Р…Р Вµ Р С‘Р В·Р СР ВµРЎР‚Р С‘Р В»Р С‘ РЎвЂљР ВµР С”РЎРѓРЎвЂљ): Р В»Р С‘Р В±Р С• Р В·Р В°Р Т‘Р В°Р Р…Р Р…Р В°РЎРЏ РЎР‚РЎС“Р С”Р В°Р СР С‘, Р В»Р С‘Р В±Р С• Р СР В°Р С”РЎРѓР С‘Р СРЎС“Р С Р С”Р В°Р С” Р В±Р ВµР В·Р С•Р С—Р В°РЎРѓР Р…Р В°РЎРЏ Р В·Р В°Р С–Р В»РЎС“РЎв‚¬Р С”Р В°
            local WorkingHeight = Cfg.Height or Cfg.MaxHeight
            ...
            -- Р РЋРЎвЂЎР С‘РЎвЂљР В°Р ВµР С Р С—Р С•Р В·Р С‘РЎвЂ Р С‘РЎР‹: РЎР‚РЎРЏР Т‘Р С•Р С РЎРѓ Р С–Р В»Р В°Р Р†Р Р…РЎвЂ№Р С Р С•Р С”Р Р…Р С•Р С Р В»Р С‘Р В±РЎвЂ№, Р В»Р С‘Р В±Р С• Р С—Р С• РЎвЂ Р ВµР Р…РЎвЂљРЎР‚РЎС“ РЎРЊР С”РЎР‚Р В°Р Р…Р В° (fallback)
            local function ComputePosition(height)
                local MainWindow = Cfg.AnchorWindow and Cfg.AnchorWindow.Items and Cfg.AnchorWindow.Items.Window
                ...
                if MainWindow then
                    ...
                    return dim2(0.5, -Cfg.Width / 2, 0.5, -height / 2)
                end
            end
            ...
            Items.Window = Library:Create("Frame", {
                Parent = Items.Gui;
                Name = "\0";
                Position = ComputePosition(WorkingHeight);
                BorderColor3 = rgb(0, 0, 0);
                Size = dim2(0, Cfg.Width, 0, WorkingHeight);
                BorderSizePixel = 0;
                BackgroundColor3 = themes.preset.outline;
                Visible = not AutoHeight; -- Р ВµРЎРѓР В»Р С‘ Р В°Р Р†РЎвЂљР С•-Р Р†РЎвЂ№РЎРѓР С•РЎвЂљР В° РІР‚вЂќ Р С—РЎР‚РЎРЏРЎвЂЎР ВµР С Р С•Р С”Р Р…Р С•, Р С—Р С•Р С”Р В° Р Р…Р Вµ Р С‘Р В·Р СР ВµРЎР‚Р С‘Р С РЎвЂљР ВµР С”РЎРѓРЎвЂљ (РЎвЂЎРЎвЂљР С•Р В±РЎвЂ№ Р Р…Р Вµ Р СР С‘Р С–Р В°Р В»Р С•)
            }); Library:Themify(Items.Window, "outline", "BackgroundColor3")
            ...
            -- Р РЋР С‘Р Р…РЎРЏРЎРЏ Р В°Р С”РЎвЂ Р ВµР Р…РЎвЂљ-Р С—Р С•Р В»Р С•РЎРѓР С”Р В° РЎРѓР Р†Р ВµРЎР‚РЎвЂ¦РЎС“, Р С”Р В°Р С” РЎС“ Р С•РЎРѓРЎвЂљР В°Р В»РЎРЉР Р…РЎвЂ№РЎвЂ¦ Р С•Р С”Р С•Р Р… Р В±Р С‘Р В±Р В»Р С‘Р С•РЎвЂљР ВµР С”Р С‘
            Items.Accent = Library:Create("Frame", {
                Parent = Items.Window;
                Name = "\0";
                Position = dim2(0, 1, 0, 1);
            ...
            -- Р СџР В»Р В°Р Р†Р Р…Р С•Р Вµ Р В·Р В°Р С”РЎР‚РЎвЂ№РЎвЂљР С‘Р Вµ РЎРѓ РЎвЂћР ВµР в„–Р Т‘Р С•Р С (Р С”Р В°Р С” РЎС“ PetPanel), Р С—Р С•РЎвЂљР С•Р С РЎС“Р Р…Р С‘РЎвЂЎРЎвЂљР С•Р В¶Р ВµР Р…Р С‘Р Вµ
            Items.Tweening = false
            Items.ToggleVisible = function(state)
                if Items.Tweening then
                    return
                end
            ...
            -- Р вЂ”Р В°Р С”РЎР‚РЎвЂ№РЎвЂљР С‘Р Вµ РЎС“Р Р…Р С‘РЎвЂЎРЎвЂљР С•Р В¶Р В°Р ВµРЎвЂљ Р С•Р С”Р Р…Р С• Р Р…Р В°РЎРѓР С•Р Р†РЎРѓР ВµР С РІР‚вЂќ Р С—РЎР‚Р С‘ Р С—Р С•Р Р†РЎвЂљР С•РЎР‚Р Р…Р С•Р С Р С•РЎвЂљР С”РЎР‚РЎвЂ№РЎвЂљР С‘Р С‘/Р В·Р В°Р С”РЎР‚РЎвЂ№РЎвЂљР С‘Р С‘ Р В»Р С‘Р В±РЎвЂ№ Р С•Р Р…Р С• Р СњР вЂў Р С—Р С•РЎРЏР Р†Р С‘РЎвЂљРЎРѓРЎРЏ РЎРѓР Р…Р С•Р Р†Р В°.
            -- Р СџР С•РЎРЏР Р†Р С‘РЎвЂљРЎРѓРЎРЏ РЎвЂљР С•Р В»РЎРЉР С”Р С• Р С—РЎР‚Р С‘ РЎРѓР В»Р ВµР Т‘РЎС“РЎР‹РЎвЂ°Р ВµР С Р В·Р В°Р С—РЎС“РЎРѓР С”Р Вµ РЎРѓР С”РЎР‚Р С‘Р С—РЎвЂљР В° (Р Р…Р С•Р Р†Р С•Р в„– РЎРѓР ВµРЎРѓРЎРѓР С‘Р С‘).
            Library:Connection(Items.CloseBtn.MouseButton1Click, function()
                Items.ToggleVisible(false)
            end)
            ...
            -- Р РЋР С”РЎР‚Р С•Р В»Р В»РЎРЏРЎвЂ°Р С‘Р в„–РЎРѓРЎРЏ РЎРѓР С—Р С‘РЎРѓР С•Р С” Р В·Р В°Р С—Р С‘РЎРѓР ВµР в„–
            Items.Scroll = Library:Create("ScrollingFrame", {
                ...
                CanvasSize = dim2(0, 0, 0, 0);
                AutomaticCanvasSize = Enum.AutomaticSize.Y;
            }); Library:Themify(Items.Scroll, "accent", "ScrollBarImageColor3")
            ...
            for i, line in Cfg.Entries do
                local Entry = Library:Create("TextLabel", {
                    ...
                    BorderSizePixel = 0;
                    LayoutOrder = i;
                }); Library:Themify(Entry, "text_color", "TextColor3")
            end

            -- Р С’Р Р†РЎвЂљР С•-Р Р†РЎвЂ№РЎРѓР С•РЎвЂљР В°: Р СР ВµРЎР‚РЎРЏР ВµР С РЎР‚Р ВµР В°Р В»РЎРЉР Р…РЎвЂ№Р в„– Р С•Р В±РЎР‰РЎвЂР С РЎвЂљР ВµР С”РЎРѓРЎвЂљР В° Р С‘ Р С—Р С•Р Т‘Р С–Р С•Р Р…РЎРЏР ВµР С Р С•Р С”Р Р…Р С• Р С—Р С•Р Т‘ Р Р…Р ВµР С–Р С• (Р Р† РЎР‚Р В°Р СР С”Р В°РЎвЂ¦ Min/MaxHeight)
            if AutoHeight then
                task.wait() -- Р С•Р Т‘Р С‘Р Р… Р С”Р В°Р Т‘РЎР‚, РЎвЂЎРЎвЂљР С•Р В±РЎвЂ№ TextLabel'РЎвЂ№ Р С‘ UIListLayout Р Т‘Р С•РЎРѓРЎвЂЎР С‘РЎвЂљР В°Р В»Р С‘ РЎР‚Р ВµР В°Р В»РЎРЉР Р…РЎС“РЎР‹ Р Р†РЎвЂ№РЎРѓР С•РЎвЂљРЎС“ РЎвЂљР ВµР С”РЎРѓРЎвЂљР В°

                local ContentHeight = Items.Layout.AbsoluteContentSize.Y
                local FinalHeight = math.clamp(ContentHeight + ChromeHeight, Cfg.MinHeight, Cfg.MaxHeight)

                Cfg.Height = FinalHeight
                Items.Window.Size = dim2(0, Cfg.Width, 0, FinalHeight)
                Items.Window.Position = ComputePosition(FinalHeight)
                Items.Window.Visible = true
            end
